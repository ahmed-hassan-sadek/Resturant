...
@section('content')
  ...
  <div class="row">
    <div class="col-lg-12 col-md-12">
      <div class="card">
        <div class="card-body">
          <form method="post" action="{{route('about.update')}}" enctype="multipart/form-data" data-parsley-validate="">
          @csrf
          @method('PUT')
            ...
            <div class="row row-xs">
              ...
              <div class="col-sm-12 col-md-4 mg-t-20">
                ...
                <input type="file" class="dropify" data-default-file="{{ URL::asset('images/about/' . $about->image) }}" name="image" data-width="280" data-height="420"/>
              </div>
              <div class="col-12">
