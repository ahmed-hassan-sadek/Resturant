                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex my-xl-auto right-content">
                      <form method="post" action="{{route('about.delete')}}">
                        @csrf
                        @method('DELETE')
                      ...
                      <div class="pr-1 mb-3 mb-xl-0">
                        <a type="button" href="{{route('about.edit', [$about->id])}}" class="btn btn-warning  btn-icon mr-2" data-placement="top" data-toggle="tooltip" title="Edit"><i class="fas fa-user-edit"></i></a>
                      </div>
                    </div>
                  </td>
                </tr>
