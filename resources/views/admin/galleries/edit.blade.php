    ...
    <div class="col-lg-12 col-md-12">
      <div class="card">
        <div class="card-body">
          ...
          <form data-parsley-validate="" action="{{ route('gallery.update') }}" method="post" enctype="multipart/form-data" >
          @csrf
          @method('PUT')
            ...
            <div class="col-md-12">
                  ...
                  <input class="form-control @error('title') is-invalid fparsley-error parsley-error @enderror" name="name" placeholder="Enter title" required type="text" value="{{ $gallery->name }}">
                  @error('name')
              ...
              <div class="col-sm-12 col-md-4 mg-t-20">
                ...
                <input type="file" class="dropify" name="image" data-default-file="{{ URL::asset('images/gallery/' . $gallery->image) }}"  data-width="280" data-height="420"/>
              </div>
              <div class="col-12">
