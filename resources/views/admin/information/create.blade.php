...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Information</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Create</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-body">
          ...
          <form action="{{route('information.store')}}" method="post" data-parsley-validate="" id="selectForm" name="selectForm">
              @csrf
            <div class="row row-xs">
              ...
              <div class="col-md-12 mg-t-20">
                <div class="form-group">
                  ...
                  <input class="form-control" name="value" placeholder="Enter value" required type="text">
                </div><!-- main-form-group -->
              </div>
