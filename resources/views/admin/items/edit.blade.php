    ...
    <div class="col-lg-12 col-md-12">
      <div class="card">
        <div class="card-body">
          ...
          <form action="{{ route('item.update') }}" method="post" data-parsley-validate="">
            @csrf
            @method('PUT')
            ...
            <div class="row row-xs">
              <div class="col-md-12 mg-t-10">
                <div class="form-group">
                  ...
                  <input class="form-control @error('title') is-invalid fparsley-error parsley-error @enderror" name="title" placeholder="Enter title" required type="text" value="{{ $item->name }}">
                  @error('title')
              ...
              <div class="col-md-12 mg-t-10">
                <div class="form-group">
                  ...
                  <textarea class="form-control @error('description') is-invalid fparsley-error parsley-error @enderror" placeholder="Enter description" required name="description" rows="5">{{ $item->desc }}</textarea>
                  @error('description')
                  <span class="invalid-feedback text-danger" role="alert">
                      <p>{{ $message }}</p>
                  </span>
              ...
              <div class="col-md-12 mg-t-10">
                <div class="form-group">
                  ...
                  <input class="form-control @error('price') is-invalid fparsley-error parsley-error @enderror" name="price" placeholder="Enter price" required type="text" value="{{ $item->price }}">
                  @error('price')
                  <span class="invalid-feedback text-danger" role="alert">
                    <p>{{ $message }}</p>
                  </span>
