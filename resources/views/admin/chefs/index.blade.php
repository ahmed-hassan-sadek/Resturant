          ...
          <div class="table-responsive">
            ...
            <table id="example" class="table table-hover key-buttons text-md-nowrap">
              ...
              @foreach($chefs as $chef)
                <tr>
                  <td>
                    <img src="{{asset('images/chefs/'.$chef->image)}}" height="200px">
                  </td>
                  <td>{{$chef->name}}</td>
                  <td>{{$chef->body}}</td>
                  <td>
                    <div class="d-flex my-xl-auto right-content">
                      ...
                      <div class="pr-1 mb-3 mb-xl-0">
                        <a type="button" href="{{route('chefs.edit', [$chef->id])}}" class="btn btn-warning  btn-icon mr-2" data-placement="top" data-toggle="tooltip" title="Edit"><i class="fas fa-user-edit"></i></a>
                      </div>
                    </div>
                  </td>
                </tr>
