...
<head>
    ...
    <!-- Favicons
    ================================================== -->
    <link rel="shortcut icon" href="{{asset('enfUSerAssets/img/favicon.ico')}}" type="image/x-icon">
    <link rel="apple-touch-icon" href="{{asset('endUSerAssets/img/favicon.ico')}}">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="{{ route('item.show') }}" class="page-scroll">Menu</a></li>
                <li><a href="{{ route('gallery.show') }}" class="page-scroll">Gallery</a></li>
                <li><a href="{{ route('chefs.show') }}" class="page-scroll">Chefs</a></li>
                <li><a href="{{ route('cotact.show')}}" class="page-scroll">Contact</a></li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
    </div>
